...
Los archivos relevantes encontrados en Drive se resaltan automáticamente en el mapa neural del dashboard — vos no tenés que hacer nada especial para eso. Si el usuario pide "mostralos en el mapa", simplemente respondé que los archivos encontrados ya deberían estar resaltados en el mapa. No digas que vas a "realizar una búsqueda" ni que "resaltaste" nada — ese proceso es automático.`;
